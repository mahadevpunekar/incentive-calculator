...
export const mockRuleEngineRules: RuleEngineRule[] = [
  {
    ...
    incentivePercent: 0.4,
    effectSummary: "+0.4% commission when the combined condition matches",
  ...
  },
  {
    ...
    incentivePercent: 0,
    effectSummary: "SPIFF stack suppressed when exclude matches (0% add-on)",
  ...
  },
  {
    ...
    effectSummary: "Draft — tier-2 medical kicker for named producers",
